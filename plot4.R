...
plot(household$Date_Time, household$Voltage, type = "l", xlab = "", ylab = "Voltage")
...
plot(household$Date_Time, household$Global_reactive_power, type = "l", xlab = "", ylab = "Global Reactive Power")
